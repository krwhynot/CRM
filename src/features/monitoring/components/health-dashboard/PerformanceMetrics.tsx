      ...
      <CardContent>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-lg border p-4 text-center">
            <div className="text-2xl font-bold text-blue-600">{performance.averageQueryTime}ms</div>
            <div className="text-sm text-gray-600">Average Query Time</div>
            <div className="text-xs text-gray-500">Target: &lt;25ms</div>
          </div>

          <div className="rounded-lg border p-4 text-center">
            <div className="text-2xl font-bold text-green-600">{performance.pageLoadTime}ms</div>
