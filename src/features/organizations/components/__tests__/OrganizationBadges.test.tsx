...
describe('OrganizationBadges', () => {
  it('should render priority and type badges', () => {
    render(<OrganizationBadges priority="A" type="customer" segment={null} />)
  ...
  it('should render segment badge when segment is provided', () => {
    render(<OrganizationBadges priority="B" type="distributor" segment="Restaurant" />)
  ...
  it('should render status badge for VIP customers', () => {
    render(<OrganizationBadges priority="A+" type="customer" segment="Restaurant" />)
  ...
  it('should not render segment badge when segment is null', () => {
    render(<OrganizationBadges priority="C" type="customer" segment={null} />)
  ...
  it('should apply custom className', () => {
    const { container } = render(
      <OrganizationBadges priority="A" type="customer" segment={null} className="custom-class" />
    )
  ...
  it('should handle null/undefined values gracefully', () => {
    render(<OrganizationBadges priority={null} type={null} segment={null} />)
