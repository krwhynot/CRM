  ...
  const handleUpdateOpportunity = useCallback(
    async (data: OpportunityFormData, opportunity: Opportunity, onSuccess: () => void) => {
      try {
        ...
        const {
          principals: _principals, // eslint-disable-line @typescript-eslint/no-unused-vars
          auto_generated_name: _autoGeneratedName, // eslint-disable-line @typescript-eslint/no-unused-vars
          ...updateData
        } = data
