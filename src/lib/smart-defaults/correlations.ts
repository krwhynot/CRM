...
import type { ContactRole, PurchaseInfluenceLevel, DecisionAuthorityRole } from '@/types/contact.types'
 ...
 */
export const ROLE_CORRELATIONS: Record<ContactRole, {
 ...
 */
export const ORGANIZATION_TYPE_DEFAULT_ROLES: Record<OrganizationType, {
  primary: ContactRole
 ...
 */
export const JOB_TITLE_ROLE_PATTERNS: Record<string, {
  role: ContactRole
  confidence: number
}> = {
  // Decision Makers
 ...
 */
export function detectContactRoleFromTitle(title: string): { role: ContactRole; confidence: number } | null {
