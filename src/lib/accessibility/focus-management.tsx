  ...
  return (
    <a
      ...
      className={cn(
        ...
        'sr-only focus:not-sr-only focus:absolute ${semanticSpacing.cardContainer} ${semanticSpacing.cardContainer} focus:z-50 ${semanticSpacing.cardContainer} focus:bg-primary focus:text-primary-foreground ${semanticRadius.input} ${semanticShadows.card}',
        className || ''
      )}
      onFocus={(e) => {
