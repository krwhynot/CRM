...
export const organizationFormSchema = z.object({
  ...
  taxId: z.string().max(20, 'Tax ID must be less than 20 characters').optional().or(z.literal('')),
  ...
  tags: z.array(z.string()).max(15, 'Maximum 15 tags allowed').optional().default([]),
...
export const opportunityFormSchema = z.object({
  ...
  source: z.string().max(50, 'Source must be less than 50 characters').optional().or(z.literal('')),
  ...
  // Assignment
  assignedTo: z.string().uuid('Invalid user ID').min(1, 'Sales representative is required'),
  ...
  competitors: z.array(z.string()).max(5, 'Maximum 5 competitors allowed').optional().default([]),

  // System fields
  createdBy: z.string().uuid().optional(),
})

// Base interaction validation schema without refinements
const interactionFormSchemaBase = z.object({
  // Basic Information
  type: z.enum(
    ['call', 'email', 'meeting', 'demo', 'proposal', 'contract', 'support', 'follow-up', 'other'],
    {
...
// Interaction validation schema with refinements
...
export const interactionFormSchemaExtended = interactionFormSchemaBase
  .extend({
    // Content
    description: z
      .string()
    ...
    // Tags
    tags: z.array(z.string()).max(8, 'Maximum 8 tags allowed').optional().default([]),
