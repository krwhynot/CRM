...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        `bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[96%] translate-x-[-50%] translate-y-[-50%] ${semanticSpacing.gap.lg} ${semanticRadius.large} border ${semanticSpacing.cardContainer} sm:${semanticSpacing.layoutContainer} shadow-lg duration-200 sm:max-w-lg md:max-w-2xl lg:max-w-4xl focus-ring max-h-dialog overflow-hidden`,
        className
      )}
