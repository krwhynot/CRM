...
const DENSITY_PRIORITY_MAP: Record<DensityLevel, Record<string, boolean>> = {
  compact: {
      ...
      <div className={cn('space-y-2', className)}>
        ...
        <div className="flex items-center justify-between">
          <div className={cn(semanticSpacing.gap.xs, 'flex items-center')}>
            <h3 className={cn(semanticTypography.body, semanticTypography.h4, 'text-foreground')}>
              {title}
            </h3>
            {badge && (
        ...
        {/* Expandable Content */}
        <CollapsibleContent className={`${semanticSpacing.stack.xs}`}>
