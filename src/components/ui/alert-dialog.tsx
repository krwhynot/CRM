...
const AlertDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('flex flex-col text-center sm:text-left', semanticSpacing.stack.xs, className)}
    {...props}
  />
)
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn('font-semibold', semanticTypography.heading, className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      `${semanticSpacing.topGap.xs} sm:mt-0`,
      className
    )}
    {...props}
  />
