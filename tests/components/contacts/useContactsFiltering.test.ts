...
const mockContacts: ContactWithOrganization[] = [
  {
    ...
    organization_id: '1',
    organization: { id: '1', name: 'Test Corp', type: 'customer', created_at: '2024-01-01', updated_at: '2024-01-01' },
    department: 'Sales',
  ...
  },
  {
    ...
    organization_id: '2',
    organization: { id: '2', name: 'Example Inc', type: 'distributor', created_at: '2024-01-01', updated_at: '2024-01-01' },
