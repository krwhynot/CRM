// TypeScript types - POST Phase 1 Foundation Fixes
// Generated: 2025-08-20  
// Project: KitchenPantry CRM (ixitjldcdvbazvjsnkao)
// Purpose: Updated types after Phase 1: Foundation Fixes migration

// Key Changes from Phase 1:
// 1. products.created_by is now NOT NULL (was nullable before)
// 2. Organization roles synchronization implemented via trigger
// 3. Universal audit trigger enhanced to handle tables without audit fields
// 4. Uniqueness constraints added with soft-delete support
    ...
    Tables: {
      ...
      products: {
        Row: {
          ...
          created_at: string | null
          created_by: string // NOTE: NOW NOT NULL after Phase 1
          deleted_at: string | null
          description: string | null
          id: string
